...
//
echo "<table border=1><tr><th>Year</th><th>$months[0]</th><th>$months[1]</th><th>$months[2]</th>
    <th>$months[3]</th><th>$months[4]</th><th>$months[5]</th>
    <th>$months[6]</th><th>$months[7]</th><th>$months[8]</th>
    <th>$months[9]</th><th>$months[10]</th><th>$months[11]</th><th>Total:</th></tr>";
    
    $expenses=array(rand(0,999),rand(0,999),rand(0,999),rand(0,999),rand(0,999),rand(0,999),
                    rand(0,999),rand(0,999),rand(0,999),rand(0,999),rand(0,999),rand(0,999));
